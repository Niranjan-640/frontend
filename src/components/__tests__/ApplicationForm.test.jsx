...
describe('ApplicationForm', () => {
  beforeEach(() => {
    ...
    vi.stubEnv('VITE_CANDIDATES_ENDPOINT', 'http://jobportal-jobbackendportal-amkpkv-b017fc-13-203-19-120.traefik.me/');
    // Mock fetch
  ...
  it('submits the form and calls fetch with FormData and normalized endpoint', async () => {
    ...
    expect(calledUrl).toBe('http://jobportal-jobbackendportal-amkpkv-b017fc-13-203-19-120.traefik.me/');
